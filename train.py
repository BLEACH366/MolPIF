...
def get_dataloader(cfg):
    ...
    # single unit test
    # train_set = [train_set[0] for _ in range(8 * 1000)]
    # train_set = [train_set[0] for _ in range(2 * 1000)] + [train_set[1] for _ in range(2 * 1000)] + [train_set[2] for _ in range(2 * 1000)] + [train_set[3] for _ in range(2 * 1000)]
    # test_set = [train_set[0] for _ in range(20)]
    # val_set = [train_set[0] for _ in range(20)]
...
if __name__ == "__main__":
    ...
    # bfn params
    parser.add_argument("--sigma1_coord", type=float, default=0.009)
    parser.add_argument("--beta1", type=float, default=1.5)  # not used

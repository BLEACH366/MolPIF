...
if __name__ == "__main__":
    ...
    path = '/data1/jinyaowei/MolPIF/logs/epoch30/test_outputs'
    ...
    torch.save(results, os.path.join(path, f'vina_docked_new2.pt'))
    ...
    json.dump(out_metrics, open(os.path.join(path, 'metrics_new2.json'), 'w'), indent=4)
